...
public class ServerThread extends Thread{
	...
	public void run() {
		try {
			...
			String læsFraKlient = inFromClient.readLine();

			String[] requestParts = læsFraKlient.split(" ");

			String fileName = "/Users/Sebastian/Desktop/3.SEM/DIS 3.SEM/Datakommunikation/MyWeb/" + requestParts[1].substring(1);
